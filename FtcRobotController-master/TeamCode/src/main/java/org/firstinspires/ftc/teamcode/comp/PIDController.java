...
This code is our Proportional, Integral, Derivative (PID) Controller.
When out robot drives, it never drives in a complete straight line.
Our PID controller finds a straight line between where we are and where
we want to be, calculates how far off of the line we are, and corrects
itself accordingly. This allows the robot to drive in a near perfectly
straight line.
